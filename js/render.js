...
var bubble_tpl 	= ['<div class="', '" style="left:', 'px"><h3>', '</h3><img src="', '" /><p>', '</p></div>'];
	...
	$.getJSON('./data/data.json', function(data){		// get json data
		...
		$.each(data['data'], function(n, v) {
			...
			if( year != undefined ) {	// if a year label
				...
				bubble_html[c1 % 2] += bubble_tpl[0] + layout_tpl[c1 % 2] + bubble_tpl[1] + offsetToPlace + bubble_tpl[2] + title + bubble_tpl[3] + thumb + bubble_tpl[4] + desc + bubble_tpl[5];
